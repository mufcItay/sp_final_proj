...
char** createInitialBoard()
{
	...
	board[0][0]=SOLDIER_TYPE_WHITE_ROCK; board[0][1]=SOLDIER_TYPE_WHITE_KNIGHT;board[0][2]=SOLDIER_TYPE_WHITE_BISHOP;board[0][3]=SOLDIER_TYPE_WHITE_QUEEN; board[0][4]=SOLDIER_TYPE_WHITE_KING;board[0][5]=SOLDIER_TYPE_WHITE_BISHOP;board[0][6]=SOLDIER_TYPE_WHITE_KNIGHT;board[0][7]=SOLDIER_TYPE_WHITE_ROCK;
	board[1][0]=SOLDIER_TYPE_WHITE_PAWN; board[1][1]=SOLDIER_TYPE_WHITE_PAWN;board[1][2]=SOLDIER_TYPE_WHITE_PAWN;board[1][3]=SOLDIER_TYPE_WHITE_PAWN; board[1][4]=SOLDIER_TYPE_WHITE_PAWN;board[1][5]=SOLDIER_TYPE_WHITE_PAWN;board[1][6]=SOLDIER_TYPE_WHITE_PAWN;board[1][7]=SOLDIER_TYPE_WHITE_PAWN;
	...
	board[6][0]=SOLDIER_TYPE_BLACK_PAWN; board[6][1]=SOLDIER_TYPE_BLACK_PAWN;board[6][2]=SOLDIER_TYPE_BLACK_PAWN;board[6][3]=SOLDIER_TYPE_BLACK_PAWN; board[6][4]=SOLDIER_TYPE_BLACK_PAWN;board[6][5]=SOLDIER_TYPE_BLACK_PAWN;board[6][6]=SOLDIER_TYPE_BLACK_PAWN;board[6][7]=SOLDIER_TYPE_BLACK_PAWN;
	board[7][0]=SOLDIER_TYPE_BLACK_ROCK; board[7][1]=SOLDIER_TYPE_BLACK_KNIGHT;board[7][2]=SOLDIER_TYPE_BLACK_BISHOP;board[7][3]=SOLDIER_TYPE_BLACK_QUEEN; board[7][4]=SOLDIER_TYPE_BLACK_KING;board[7][5]=SOLDIER_TYPE_BLACK_BISHOP;board[7][6]=SOLDIER_TYPE_BLACK_KNIGHT;board[7][7]=SOLDIER_TYPE_BLACK_ROCK;
